#!/bin/bash
#
# This script builds the custom Redis Docker image, tags it for GitHub
# Container Registry (GHCR), and pushes it.
#
# It requires the following environment variables to be set:
# - GH_USER: The GitHub username or organization name.
...
# Configuration
IMAGE_NAME="csb-redis-az"
IMAGE_TAG="latest"
DOCKER_CONTEXT_PATH="./redis" # Path to the directory with the Dockerfile
