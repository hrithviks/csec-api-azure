...
##############################################
# Set credentials for Backend Database Users #
##############################################

# For csb_app user
resource "random_password" "csb_app_user_pswd" {
  length  = var.db_postgres_user_password_chars
  special = true
}

# For csb_api user
resource "random_password" "csb_api_user_pswd" {
  length  = var.db_postgres_user_password_chars
  special = true
}

# For csb_aws user
resource "random_password" "csb_aws_user_pswd" {
  length  = var.db_postgres_user_password_chars
  special = true
}

# For csb_azure user
resource "random_password" "csb_azure_user_pswd" {
  length  = var.db_postgres_user_password_chars
  special = true
}
