...
variable "storage_account_min_tls_version" {
  type        = string
  description = "The minimum TLS version for the storage account. Should be TLS1_2 for security."
  default     = "TLS1_2"

  validation {
    condition     = var.storage_account_min_tls_version == "TLS1_2"
    error_message = "For security, the minimum TLS version for the storage account must be 'TLS1_2'."
  }
}
