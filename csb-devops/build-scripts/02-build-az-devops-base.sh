...
# Configuration
AZ_DEVOPS_RESOURCE_GROUP="csec-devops-rg"
AZ_STORAGE_ACCOUNT_NAME="csecinfracontainer"
AZ_STORAGE_CONTAINER_NAME="csec-infra-state-v1"
AZ_LOCATION="southeastasia"
AZ_STORAGE_ROLE_NAME="Storage Blob Data Contributor"
AZ_DEVOPS_VNET="csec-devops-vnet"
AZ_DEVOPS_SUBNET="csec-devops-snet"
...
terraform plan \
 ...
 -var="tenant_id=${AZ_DEVOPS_TENANT_ID}" \
 -var="storage_account_name=${AZ_STORAGE_ACCOUNT_NAME}" \
 -var="container_name=${AZ_STORAGE_CONTAINER_NAME}" \
